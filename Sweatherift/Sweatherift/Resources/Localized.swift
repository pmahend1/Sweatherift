...
enum Localized {
   ...
   static let goToHttpsHomeOpenweathermapOrgApiKeysToGetAKey = String(localized: "goToOpenweathermapOrgApiKeysToGetAKey", comment: "Go to https://home.openweathermap.org/api_keys to get a key")
   ...
   static let registerAtHttpsOpenweathermapOrg = String(localized: "registerAtOpenweathermapOrg", comment: "Register at https://openweathermap.org/")
